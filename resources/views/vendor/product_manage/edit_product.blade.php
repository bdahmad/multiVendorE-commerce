...
@section('content')
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{route('vendor.all.product')}}" class="btn btn-primary">All Product</a>
                </div>
            </div>
        </div>
        <!--end breadcrumb-->
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <div class="input-group mb-3">
                    <input type="reset" class="btn btn-danger" id="vendor_product_add_reset_btn" />
                    <button type="submit" class="btn btn-success" id="vendor_product_add_btn">Update Product</button>
                </div>
            </div><!--end row-->
        </div>
    </form>
        ...
        <div class="card-body">
            ...
            <!-- Modal -->
                <div class="modal fade" id="imgUploadModal" tabindex="-1" aria-labelledby="imgUploadModalLabel" aria-hidden="true">
                    <form action="{{route('vendor.product.single.image.update')}}" method="POST" enctype="multipart/form-data">
                        @csrf
