                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <span class="text-secondary" id="adnim_web_link_show">https://codervent.com</span>

                                        <a class="btn btn-info btn-sm" id="admin_web_edit_btn"><i class="fa fa-pencil"></i></a>
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <a class="btn btn-info btn-sm" id="admin_github_edit_btn"><i class="fa fa-pencil"></i></a>

                                        <div class="" id="admin_github_link_input_form">
                                            <form action="" method="post">
                                                @csrf
                                                <input type="text" class="form-control my-3" placeholder="Give Your Github Link">
                                                <button type="submit" class="btn btn-success btn-sm"><i class="fa fa-check"></i></button>
                                                <button type="reset" class="btn btn-danger btn-sm" id="admin_github_input_from_close"><i class="fa fa-close"></i></button>
                                            </form>
                                        </div>
