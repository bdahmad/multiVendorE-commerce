            ...
            <div class="container">
                <div class="section-title style-2 wow animate__animated animate__fadeIn">
                    ...
                    <ul class="nav nav-tabs links" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="nav-{{$item->category_id}}" data-bs-toggle="tab" data-bs-target="#{{$item->category_id}}"
                                type="button" role="tab" aria-controls="{{$item->category_id}}" aria-selected="false">{{$item->category_name}}</button>
                        </li>
                        @endforeach
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="{{$item->category_id}}" role="tabpanel" aria-labelledby="{{$item->category_id}}">
                        <div class="row product-grid-4">
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
